...
declare global {
  ...
  const blobToBase64: typeof import('./utils/fileBase64').blobToBase64
  const blobToWavBase64: typeof import('./utils/fileBase64').blobToWavBase64
  ...
  const effectScope: typeof import('vue').effectScope
  const encodeSampleForClone: typeof import('./utils/fileBase64').encodeSampleForClone
  ...
  const removeAppLoading: typeof import('./utils/app-loading').removeAppLoading
  ...
  const useA2UIRenderer: typeof import('./hooks/useA2UIRenderer').useA2UIRenderer
  ...
  const useBrowserCallTest: typeof import('./hooks/useBrowserCallTest').useBrowserCallTest
  ...
  const useDictLabel: typeof import('./hooks/useDict').useDictLabel
  ...
  const useMixMenu: typeof import('./hooks/useMixMenu').useMixMenu
  ...
  const useResponsive: typeof import('./hooks/useResponsive').useResponsive
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { EntityId } from './utils/id'
  import('./utils/id')
  // @ts-ignore
